...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light ">
    <a class="nav-link m-3" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars"></i></a>
    <div class="container-fluid">
      ...
      <div class="search_box_wrapper">
        <div class="search_box_item search_box_item_1 grup-input">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
      <div class="ms-2 user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image mt-2">
          <img src="dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info ms-3">
          <a href="#" class="d-block text-decoration-none text-white">Alexander Pierce</a>
    ...
    <div class="sidebar">
      <!-- Sidebar Menu -->
    <nav class="mt-2 sidebar-dark-primary ">

        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">

          <li class="nav-item">
            <a href="pages/gallery.html" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-house-dash-fill" viewBox="0 0 16 16">
